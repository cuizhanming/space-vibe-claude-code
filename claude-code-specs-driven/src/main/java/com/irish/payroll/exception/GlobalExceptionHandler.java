...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleTaxCalculationException(TaxCalculationException ex) {
        ErrorResponse error = new ErrorResponse(
    ...
    public ResponseEntity<ErrorResponse> handlePayrollProcessingException(PayrollProcessingException ex) {
        ErrorResponse error = new ErrorResponse(
